package io.imagine.edition.unit;
...
import io.imagine.edition.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("io.imagine.edition.endpoint.event.gen.UuidCreated", payload);
